...
fig = run_cellchat_diff_analysis(
    adata=adata_curio,
    cell_type_col=cell_type_col,
    condition_col='condition',
    conditions=('CTRL', 'PREG'),
    measure='count',
    senders_to_keep=selected_cell_types,
    title='Differential Interaction Count (PREG vs CTRL)'
)
fig.savefig(
    f'{working_dir}/figures/cellchat_diff_count_preg_vs_ctrl.png',
    dpi=300, bbox_inches='tight'
)
fig.savefig(
    f'{working_dir}/figures/cellchat_diff_count_preg_vs_ctrl.svg',
    dpi=300, bbox_inches='tight'
)
plt.close(fig)
...
fig = run_cellchat_diff_analysis(
    ...
    conditions=('CTRL', 'PREG'),
    measure='weight',
    senders_to_keep=senders,
    title='Differential Interaction Strength (PREG vs CTRL)'
)
fig.savefig(
    f'{working_dir}/figures/cellchat_diff_weight_preg_vs_ctrl.png',
    dpi=300, bbox_inches='tight'
)
fig.savefig(
    f'{working_dir}/figures/cellchat_diff_weight_preg_vs_ctrl.svg',
    dpi=300, bbox_inches='tight'
)
plt.close(fig)
# ... existing code ...